...
urlpatterns = [
                  ...
                  path('recommed/', views.recommed, name='recommed'),
                  path('recommed/result/', views.result),
                  # mobile navbar start-urls.py,views.py,mobile.html this page are link
                  path('mobile/', views.mobile, name='mobile'),
                  path('mobile/<slug:data>', views.mobile, name='mobiledata'),
                  # topwear navbar start-urls.py,views.py,mobile.html this page are link
                  path('topwear/', views.topwear, name='topwear'),
                  path('topwear/<slug:data>', views.topwear, name='topweardata'),

                  # bottomwear navbar start-urls.py,views.py,mobile.html this page are link
